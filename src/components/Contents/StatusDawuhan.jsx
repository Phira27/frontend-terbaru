...
const StatusLumajang = () => {
  ...
  return (
    <div className="text-2xl px-5 py-5 text-zinc-600 bg-white
      border-slate-300 max-w-md md:max-w-2xl box-content h-300 w-700 border-2
        ...
        <div className="flex">
          ...
          <div className="ml-4 flex flex-col justify-center">
            <div className="inline-block align-middle flex flex-col items-center">
              <div className="text-5xl font-bold px-20 animate-bounce">{weatherData?.temperature || '60'}</div>
              <div className="text-xl mt-1 justify-stretch">{weatherData?.condition || 'Sedang'}</div>
            </div>
          </div>
        </div>
        <div className="flex flex-col items-end">
          <div className="text-2xl font-semibold">{weatherData?.location ||'Lumajang'}</div>
