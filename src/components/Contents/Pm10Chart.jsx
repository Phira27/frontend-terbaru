...
function Pm10Chart() {
  ...
  return (
    <div className='pr-3'>
      <h2 className='text-2xl font-bold text-gray-800 text-center mb-1'>PM 10</h2>
      {chartData.length > 0 ? (
        ...
        <LineChart data={chartData}>
          ...
          <Tooltip />
          <Legend />
          <Line type="monotone" dataKey="pasirian_PM10" stroke="#8884d8" name="Pasirian " />
          <Line type="monotone" dataKey="lumajang_PM10" stroke="#82ca9d" name="Lumajang " />
          <Line type="monotone" dataKey="senduro_PM10" stroke="#ffc658" name="Senduro " />
        </LineChart>
        </ResponsiveContainer>
      ) : (
        <p>Loading data...</p>
